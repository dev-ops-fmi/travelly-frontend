...
export class ItineraryService {
  private apiUrl = `${API_PREFIX}/itineraries`;
  ...
  addAccommodations(accommodations: Accommodation[]): Observable<any> {
    return this.http.post(
      `${this.apiUrl}/${this.getItineraryId()}/accommodations`,
      accommodations
    );
  }
  ...
  addActivities(activities: Activity[]): Observable<any> {
    return this.http.post(
      `${this.apiUrl}/${this.getItineraryId()}/activities`,
      activities
    );
  }

  addTransportationOptions(
    transportationOptions: TransportationOption[]
  ): Observable<any> {
    return this.http.post(
      `${this.apiUrl}/${this.getItineraryId()}/transportationOptions`,
  ...
  getAccommodations(itineraryId: number): Observable<Accommodation[]> {
    return this.http.get<Accommodation[]>(
      `${this.apiUrl}/${itineraryId}/accommodations`
    );
  }

  getMapAccommodations(itineraryId: number): Observable<AccommodationMap[]> {
    return this.http.get<AccommodationMap[]>(
      `${this.apiUrl}/${itineraryId}/accommodations/map`
    );
  }

  getActivities(itineraryId: number): Observable<Activity[]> {
    return this.http.get<Activity[]>(
      `${this.apiUrl}/${itineraryId}/activities`
    );
  }

  getMapActivities(itineraryId: number): Observable<ActivityMap[]> {
    return this.http.get<ActivityMap[]>(
      `${this.apiUrl}/${itineraryId}/activities/map`
    );
  }
  ...
  getTransportationOptions(
    ...
    return this.http.get<TransportationOption[]>(
      `${this.apiUrl}/${itineraryId}/transportationOptions`
    );
  }

  getMapTransportationOptions(
    itineraryId: number
  ): Observable<TransportationOptionMap[]> {
    return this.http.get<TransportationOptionMap[]>(
      `${this.apiUrl}/${itineraryId}/transportationOptions/map`
    );
  }
